// ============================================================
// NC Tool | F3 — Validator  ·  HealthCheck.gs  (Backup)
// Verifica estrutura completa da planilha e gera relatório
// Disponível em NC Tool → 🩺 Health Check
// ============================================================

var HC_SHEET_ID = '1Dthsg7TWuYfQi-QU1yCkRJEhFdXKQ3I1wNO5Y90CCEQ';
...
function runHealthCheck() {
  ...
  linhas.push('Pessoal (Backup) · ' + new Date().toLocaleString('pt-BR'));
  linhas.push('');
