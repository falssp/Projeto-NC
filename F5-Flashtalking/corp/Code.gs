/* ═══════════════════════════════════════════════════════════════════
   ...
   Code.gs — Script principal · NC Tool | Unilever BR x Grasp — Script F5
   Planilha : 1Y7_1NL7Uo9HgHn7bTIqnnVZhJCogCbXI3tgasxOTN_0
   ═══════════════════════════════════════════════════════════════════ */

/* ─── IDs ─── */
const SPREADSHEET_ID  = '1Y7_1NL7Uo9HgHn7bTIqnnVZhJCogCbXI3tgasxOTN_0';
...
function abrirValidador() {
  const url = 'https://script.google.com/macros/s/AKfycbwKsOut5TyYLf1pW_xm1He-zBvzZGYFM4KAEE5C6hssNZHsg9fL_QBXWjfF-zzIDxfXNQ/exec';
