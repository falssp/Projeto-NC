/**
 * DICIONÁRIO DE TAXONOMIAS UL — Pessoal
...
function lerAba() {
  ...
  // Location FT: adicionar group, display e reordenar
  const LOCATION_NOMES = {
  'nac': 'Nacional',
  'reg-co': 'Centro-Oeste',
  'reg-co-se': 'Centro-Oeste + Sudeste',
  'reg-ne': 'Nordeste',
  'reg-ne-se': 'Nordeste + Sudeste',
  'reg-ne-se-su': 'Nordeste + Sudeste + Sul',
  'reg-no': 'Norte',
  'reg-no-ne': 'Norte + Nordeste',
  'reg-no-se': 'Norte + Sudeste',
  'reg-no-se-su': 'Norte + Sudeste + Sul',
  'reg-se': 'Sudeste',
  'reg-su': 'Sul',
  'reg-su-se': 'Sul + Sudeste',
  'est-ac': 'Acre',
  'est-al': 'Alagoas',
  'est-am': 'Amazonas',
  'est-ap': 'Amapá',
  'est-ba': 'Bahia',
  'est-ce': 'Ceará',
  'est-df': 'Distrito Federal',
  'est-es': 'Espírito Santo',
  'est-go': 'Goiás',
  'est-ma': 'Maranhão',
  'est-mg': 'Minas Gerais',
  'est-ms': 'Mato Grosso do Sul',
  'est-mt': 'Mato Grosso',
  'est-pa': 'Pará',
  'est-pb': 'Paraíba',
  'est-pe': 'Pernambuco',
  ...
  'est-rn': 'Rio Grande do Norte',
  'est-ro': 'Rondônia',
  'est-rr': 'Roraima',
  'est-rs': 'Rio Grande do Sul',
  'est-sc': 'Santa Catarina',
  'est-se': 'Sergipe',
  'est-sp': 'São Paulo',
  'est-to': 'Tocantins',
  'cid-aju': 'Aracaju',
  'cid-apg': 'Campo Grande (Aporé)',
  'cid-aps': 'Anápolis',
  'cid-bel': 'Belém',
  'cid-bel-mao': 'Belém + Manaus',
  'cid-bel-slz': 'Belém + São Luís',
  'cid-bhz': 'Belo Horizonte',
  'cid-bhz-jdf': 'BH + Juiz de Fora',
  'cid-bhz-udi': 'BH + Uberlândia',
  'cid-bnu': 'Blumenau',
  'cid-bnu-fln': 'Blumenau + Florianópolis',
  'cid-brb': 'Brasília',
  'cid-brb-cgb': 'Brasília + Cuiabá',
  'cid-brb-gyn': 'Brasília + Goiânia',
  'cid-cau': 'Caucaia',
  'cid-cax': 'Caxias do Sul',
  'cid-cgb': 'Cuiabá',
  'cid-cgr': 'Campo Grande',
  'cid-con': 'Contagem',
  'cid-cpq': 'Campinas',
  'cid-cpq-rao': 'Campinas + Ribeirão Preto',
  'cid-cpq-sod': 'Campinas + São José do Rio Preto',
  'cid-cwb': 'Curitiba',
  'cid-cwb-fln': 'Curitiba + Florianópolis',
  'cid-cwb-poa': 'Curitiba + Porto Alegre',
  'cid-cxj': 'Caxias do Sul (alt)',
  'cid-fec': 'Feira de Santana',
  'cid-fln': 'Florianópolis',
  'cid-for': 'Fortaleza',
  'cid-gru': 'São Paulo (Guarulhos)',
  'cid-gyn': 'Goiânia',
  'cid-imp': 'Imperatriz',
  'cid-jdf': 'Juiz de Fora',
  'cid-jdo': 'Juazeiro do Norte',
  'cid-joi': 'Joinville',
  'cid-joi-bnu': 'Joinville + Blumenau',
  'cid-joi-fln': 'Joinville + Florianópolis',
  'cid-jpa': 'João Pessoa',
  'cid-jpa-nat': 'João Pessoa + Natal',
  'cid-jpa-rec': 'João Pessoa + Recife',
  'cid-ldb': 'Londrina',
  'cid-mao': 'Manaus',
  'cid-mao-cgb': 'Manaus + Cuiabá',
  'cid-mcz': 'Maceió',
  'cid-mgf': 'Maringá',
  'cid-nat': 'Natal',
  'cid-nat-for': 'Natal + Fortaleza',
  'cid-nig': 'Niterói/Região dos Lagos',
  'cid-nit': 'Niterói',
  'cid-osa': 'Osasco',
  'cid-pet': 'Petrópolis',
  'cid-pnz': 'Petrolina/Juazeiro',
  'cid-poa': 'Porto Alegre',
  'cid-poa-fln': 'Porto Alegre + Florianópolis',
  'cid-rao': 'Ribeirão Preto',
  'cid-rao-sod': 'Ribeirão Preto + São José do Rio Preto',
  'cid-rec': 'Recife',
  'cid-rec-for': 'Recife + Fortaleza',
  'cid-rio': 'Rio de Janeiro',
  'cid-rio-bhz': 'Rio + BH',
  'cid-rio-brb': 'Rio + Brasília',
  'cid-rio-rec': 'Rio + Recife',
  'cid-rio-ssa': 'Rio + Salvador',
  'cid-sao': 'São Paulo',
  'cid-sao-bhz': 'SP + BH',
  'cid-sao-brb': 'SP + Brasília',
  'cid-sao-cpq': 'SP + Campinas',
  'cid-sao-cwb': 'SP + Curitiba',
  'cid-sao-for': 'SP + Fortaleza',
  'cid-sao-gru': 'SP + Guarulhos',
  'cid-sao-osa': 'SP + Osasco',
  'cid-sao-poa': 'SP + Porto Alegre',
  'cid-sao-rec': 'SP + Recife',
  'cid-sao-rio': 'SP + Rio',
  'cid-sao-sbc': 'SP + Santo André/SBC',
  'cid-sao-ssa': 'SP + Salvador',
  'cid-sbc': 'Santo André/SBC',
  'cid-slz': 'São Luís',
  'cid-sod': 'São José do Rio Preto',
  'cid-ssa': 'Salvador',
  'cid-ssa-for': 'Salvador + Fortaleza',
  'cid-ssa-rec': 'Salvador + Recife',
  'cid-ssz': 'Santos/Baixada Santista',
  'cid-stm': 'Santarém',
  'cid-the': 'Teresina',
  'cid-udi': 'Uberlândia',
  'cid-vix': 'Vitória',
  'cid-vix-bhz': 'Vitória + BH',
  'cid-vix-rio': 'Vitória + Rio'
};
  const LOC_ORDER = ['Nacional', 'Região', 'Estado', 'Cidade'];
  blocos.forEach(b => {
    if(b.field !== 'Location FT') return;
    b.items.forEach(it => {
      const opt = it.opt;
      if(opt === 'nac' || opt === 'nacional') it.group = 'Nacional';
      else if(opt.startsWith('reg-')) it.group = 'Região';
      else if(opt.startsWith('est-')) it.group = 'Estado';
      else if(opt.startsWith('cid-')) it.group = 'Cidade';
      else it.group = '';
      it.display = LOCATION_NOMES[opt] || opt;
    });
    b.items.sort((a, c) => {
      const ga = LOC_ORDER.indexOf(a.group), gc = LOC_ORDER.indexOf(c.group);
      if(ga !== gc) return ga - gc;
      return (a.display || a.opt).localeCompare(c.display || c.opt, 'pt-BR');
    });
  });
