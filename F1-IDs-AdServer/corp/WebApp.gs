...
const SHEET_ID_CORP = '1VBaExPGHOVYxpTyzJymrb8RuWWe34_9WBE0aC3slETU';

function doGet(e) {
  const action = (e && e.parameter && e.parameter.action) || 'ping';
  const ss     = SpreadsheetApp.openById(SHEET_ID_CORP);
...
function _statsVazio() {
  return {
    fase:'F1', env:'corp', totalSlugs:0, totalMes:0, totalSX:0, totalAMZ:0,
